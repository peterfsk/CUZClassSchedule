...
import com.asus.zhechuankebiao.data.bean.CsItem;
...
import com.asus.zhechuankebiao.data.greendao.DaoMaster;
import com.asus.zhechuankebiao.data.greendao.DaoSession;
import com.asus.zhechuankebiao.data.greendao.MyOpenHelper;
...
import com.asus.zhechuankebiao.widget.UpdateJobService;
...
public class AppUtils {
    ...
    public static void updateWidget(Context context) {
        ...
        intent.setAction("com.asus.action.UPDATE_WIDGET");
        intent.setComponent(new ComponentName("com.asus.zhechuankebiao", "com.asus.zhechuankebiao.widget.MyWidget"));
