...
import com.asus.zhechuankebiao.BaseFragment;
...
import com.asus.zhechuankebiao.mvp.about.AboutActivity;
import com.asus.zhechuankebiao.mvp.add.AddActivity;
import com.asus.zhechuankebiao.mvp.mg.MgActivity;
import com.asus.zhechuankebiao.mvp.school.SchoolActivity;
import com.asus.zhechuankebiao.setting.SettingActivity;
...
public class HomeFragment extends BaseFragment implements HomeContract.View,
    ...
    private void addSelectDialog() {
        new DialogHelper().buildBottomListDialog(activity, new String[]{"手动添加", "正方课表", "导入分享"},
                new DialogListener() {
                    @Override
