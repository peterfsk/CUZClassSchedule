...
import com.asus.zhechuankebiao.mvp.impt.ImptActivity;
...
//        dialogHelper.
                ...
                getString(R.string.please_input_school_url), new DialogListener() {
                    ...
                    public void onPositive(DialogInterface dialog, int which) {
                        ...
                        if (!schoolUrl.startsWith("http")) {
                            schoolUrl = "http://" + schoolUrl +"/"+ Url.Random24 + Url.default2;
                        }
    ...
    private void selectedCuz() {
        mPresenter.testUrl(Url.URL_CUZ_HOST);
    }
